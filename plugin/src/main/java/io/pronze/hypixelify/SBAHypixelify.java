...
public class SBAHypixelify extends PluginContainer implements SBAHypixelifyAPI {
    ...
    public static GameStorage getGamestorage(Game game) {
        if (instance.arenas.containsKey(game.getName()))
            return instance.arenas.get(game.getName()).getStorage();
    ...
    public static Arena getArena(String arenaName) { return instance.arenas.get(arenaName); }

    public static void addArena(Arena arena) { instance.arenas.put(arena.getGame().getName(), arena); }

    public static void removeArena(String arenaName) { instance.arenas.remove(arenaName); }
    ...
    public static PlayerWrapperService getWrapperService() {
        return instance.playerWrapperService;
    }
    ...
    public static void debug(String message) {
        if (!instance.debug || message == null) return;
    ...
    public void onDisable() {
        ...
        this.getServer().getScheduler().cancelTasks(instance);
        this.getServer().getServicesManager().unregisterAll(instance);
