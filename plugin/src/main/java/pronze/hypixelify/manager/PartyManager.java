package pronze.hypixelify.manager;
...
public class PartyManager implements pronze.hypixelify.api.manager.PartyManager {

    private final Map<Player, pronze.hypixelify.party.Party> parties = new HashMap<>();
    ...
    public void disband(Player leader) {
        final pronze.hypixelify.party.Party party = parties.get(leader);
    ...
    @Override
    public pronze.hypixelify.party.Party getParty(Player player) {
    ...
    @Override
    public pronze.hypixelify.party.Party createParty(Player player) {
        if (parties.containsKey(player)) return null;
        final var party = new pronze.hypixelify.party.Party(player);
